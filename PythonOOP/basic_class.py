...
print("School Name for student1:",student1.school_name)

# Other way to access class variable using Class name itself
print("School Name for all students:",Student.school_name)
...
# Accessing the class variable using object
print("School Name for student2:",student2.school_name)
...
Total for Alen:158
Total for Bob:152
School Name for student1: Bad Coding Academy
School Name for all students: Bad Coding Academy
School Name for all students: Good Coding Academy
School Name for student1: Bad Coding Academy
School Name for student2: Good Coding Academy
'''
